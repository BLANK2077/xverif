    ...
    "exclude.add": _schema_entry(
        ...
        _request(
            ...
            args=_args({
                ...
                "signal": _string(min_length=1),
                "transition": _string(min_length=1),
                "branch": _string(min_length=1),
                "arm": _string(min_length=1),
                "condition": _string(min_length=1),
                "term": _string(min_length=1),
                "fsm": _string(min_length=1),
                "name": _string(min_length=1),
                "kind": _string(min_length=1),
                "covergroup": _string(min_length=1),
