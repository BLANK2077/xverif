...
struct TraceCompletenessFacts {
    constexpr TraceCompletenessFacts(bool ok_value = true,
                                     ...
                                     bool internal_json_parse_failed_value = false)
        : ok(ok_value),
          ...
          internal_json_parse_failed(internal_json_parse_failed_value) {}
    ...
    bool internal_json_parse_failed;
};
...
constexpr bool trace_analysis_complete(const TraceCompletenessFacts& facts) {
    return facts.ok &&
           ...
           !facts.internal_json_parse_failed;
}
